...
# -- Network
__AIMSUN_INPUT_NETWORK_DATA_PATH = path.join(
    __AIMSUN_INPUT_DATA_PATH, 'network')
...
# -- Network
__AIMSUN_INPUT_TRAFFIC_DATA_PATH = path.join(
    __AIMSUN_INPUT_DATA_PATH, 'traffic')
# - Outputs
__AIMSUN_OUTPUTS_PATH = path.join(__AIMSUN_FOLDER_PATH, 'outputs')
# -- Macrosimulations
__MACROSIMULATION_OUTPUTS_PATH = path.join(__AIMSUN_OUTPUTS_PATH,
                                           'macrosimulations')
# -- Microsimulations
__MICROSIMULATION_OUTPUTS_PATH = path.join(__AIMSUN_OUTPUTS_PATH,
                                           'microsimulations')
...
def aimsun_macro_databases_file() -> str:
    ...
    return __filepath_with_epoch_directory(
        __MACROSIMULATION_OUTPUTS_PATH, __SIMULATION_EPOCH,
...
def aimsun_micro_databases_file() -> str:
    ...
    """
    return __filepath_with_epoch_directory(
        __MICROSIMULATION_OUTPUTS_PATH, __SIMULATION_EPOCH,
        __SIMULATION_OUTPUT_DATABASE_FILENAME)
...
def detector_flow_aimsun_input_file() -> str:
    ...
    return path.join(
        __AIMSUN_INPUT_TRAFFIC_DATA_PATH,
        f"detector_flow_{__YEAR_OF_SIMULATION}.pkl")
...
def od_demand_aimsun_input_file() -> str:
    ...
    return path.join(
        __AIMSUN_INPUT_DEMAND_DATA_PATH,
        f"od_demand_{__YEAR_OF_SIMULATION}.pkl")
...
def traffic_demand_aimsun_input_file() -> str:
    ...
    return path.join(
        __AIMSUN_INPUT_DEMAND_DATA_PATH,
        f"traffic_demand_{__YEAR_OF_SIMULATION}.pkl")
